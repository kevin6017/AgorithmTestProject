...
namespace AgorithmTestProject
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            globalVars.remainingCourseList = ds.Deserialize<List<Course>>(File.OpenText("..\\..\\UniversityCoreClasses.eyaml"));
            globalVars.remainingCourseList.AddRange(ds.Deserialize<List<Course>>(File.OpenText("..\\..\\CSclasses.eyaml")));
